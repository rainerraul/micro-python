...
<br><br>
<b>14 08 2023</b><br>
Create a website <b>mcu.html</b>, to access the GPIO Pins for writing and reading a one or zero level and also the GPIO0-Pin, where the builtin LED of raspberry pico W is connected, can be accessed, too. Only the range between Pin0-Pin28 is allowed and the "LED"-string.
<br><br>
